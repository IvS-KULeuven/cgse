...
def create_write_cmd_string(transaction_id: int, cmd_address: CommandAddress | str, cmd_identifier: CommandIdentifier,
                            cargo1: str = "0000", cargo2: str = "0000"):
...
def create_read_cmd_string(transaction_id: int, cmd_address: CommandAddress | str, cmd_identifier: CommandIdentifier,
                           cargo1: str = "0000", cargo2: str = "0000"):
...
def create_cmd_string(packet_type: PacketType, transaction_id: int, cmd_address: CommandAddress | str,
                      cmd_identifier: CommandIdentifier, cargo1: str = "0000", cargo2: str = "0000"):
    ...
    cmd_string = (f"{TCU_LOGICAL_ADDRESS}{packet_type.value} {hex(transaction_id)[2:].zfill(4)} {DATA_LENGTH} "
...
# def write_read(packet: str):
#     """ Sends a packet string over the configured serial port and read a line.
#
#     Args:
#         packet (str): Packet to send.
#
#     Returns:
#         Raw data, read from the configured serial port.
#     """
#
#     # - Send packet over configured serial port
#     # - Wait 0.05s
#     # - Read line
#     # - Increment global `counter` -> used as transaction ID
#     pass
...
class TcuInterface(DeviceInterface):
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, CommandAddress.GENERAL, CommandIdentifier.TCU_MODE,
                                                        cargo2="${tcu_mode}"),
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, CommandAddress.GENERAL, GeneralCommandIdentifier.TCU_SIMULATED, cargo2="${cargo2}"),
                     process_kwargs=process_general_kwargs,
                     process_cmd_string=append_crc16,
                     post_cmd=increment_counter)
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, CommandAddress.GENERAL, GeneralCommandIdentifier.RESTART_LINKS_PERIOD_LATCH),
                     process_cmd_string=append_crc16,
                     post_cmd=increment_counter)
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_read_cmd_string(counter, CommandAddress.GENERAL, GeneralCommandIdentifier.RESTART_LINKS_PERIOD),
                     process_cmd_string=append_crc16,
                     post_cmd=increment_counter)
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, CommandAddress.GENERAL, GeneralCommandIdentifier.RESTART_LINKS_PERIOD, cargo2="${link_period}"),
                     process_kwargs=process_general_kwargs,
                     process_cmd_string=append_crc16,
                     post_cmd=increment_counter)
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.OPE_MNG_COMMAND, cargo2="${cargo2}"),
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.OPE_MNG_EVENT_CLEAR_PROTECT_FLAG, cargo2="${cargo2}"),
                     process_kwargs=process_m2md_kwargs,
                     process_cmd_string=append_crc16,
                     post_cmd=increment_counter)
    ...
    @dynamic_command(cmd_type=CommandType.TRANSACTION,
                     cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.OPE_MNG_EVENT_CLEAR, cargo2="${cargo2}"),
                     process_kwargs=process_m2md_kwargs,
                     process_cmd_string=append_crc16,
                     post_cmd=increment_counter)
    ...
    @dynamic_command(
        ...
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_CURR_OFF_CORR, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,
    )
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_CURR_GAIN_CORR, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,
    )
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_AVE_LPF_EN, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_OVC_CFG_FILTER, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_AVC_FILT_TIME, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_AVERAGE_TYPE, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_SPK_FILT_COUNTER_LIM, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.ACQ_SPK_FILT_INCR_THR, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.PROF_GEN_AXIS_STEP, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,
    )
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.PROF_GEN_AXIS_SPEED, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,)
    @dynamic_command(cmd_type=CommandType.TRANSACTION,)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, "${axis}", M2MDCommandIdentifier.PROF_GEN_AXIS_STATE_START, cargo2="${cargo2}"),
        process_kwargs=process_m2md_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_CURRENT_VALUE, cargo1="${cargo1}", cargo2="${cargo2}"),
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_ADC_CONFIGURATION_REGISTER),
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_ADC_HPF_REGISTER, cargo1="${cargo1}", cargo2="${cargo2}"),
        process_kwargs=process_tsm_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_write_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_ADC_OFC_REGISTER, cargo1="${cargo1}", cargo2="${cargo2}"),
        process_kwargs=process_tsm_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter,)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_read_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_ADC_FSC_REGISTER, cargo1="${cargo1}", cargo2="${cargo2}"),
        process_kwargs=process_tsm_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_read_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_ADC_COMMAND, cargo1="${cargo1}", cargo2="${cargo2}"),
        process_kwargs=process_tsm_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
    ...
    @dynamic_command(
        cmd_type=CommandType.TRANSACTION,
        cmd_string=create_read_cmd_string(counter, CommandAddress.TSM, TSMCommandIdentifier.TSM_ADC_CALIBRATION, cargo1="${cargo1}", cargo2="${cargo2}"),
        process_kwargs=process_tsm_kwargs,
        process_cmd_string=append_crc16,
        post_cmd=increment_counter)
